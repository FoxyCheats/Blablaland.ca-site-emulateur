...
var powerInfo = {
    ...
    //Fury Weapons
    /*10100: [13, 100, 0, 5, 5, new SocketMessage()],//GunLaserMap
    10101: [13, 101, 0, 5, 5, new SocketMessage()],//gunMissileMap
    10102: [13, 102, 0, 5, 5, new SocketMessage()],//GunBigLaserMap
    10103: [13, 103, 0, 5, 5, new SocketMessage()],//gunRedemerMap
    10104: [13, 104, 0, 5, 5, new SocketMessage()],//GunToyMap
    10105: [13, 105, 0, 5, 5, new SocketMessage()],//GunC4Map
    10106: [13, 106, 0, 5, 5, new SocketMessage()],//GunPewMap
    10107: [13, 107, 0, 5, 5, new SocketMessage()],//GunFlemmeMap
    10108: [13, 108, 0, 5, 5, new SocketMessage()],//GunCitrouilleMap
    10109: [13, 109, 0, 5, 5, new SocketMessage()],//GunThunderMap
    10110: [13, 110, 0, 5, 5, new SocketMessage()],//GunFreezeMap
    ...
    10078: [18, 78, 0, 5, 5, new SocketMessage()],
    10081: [18, 81, 0, 5, 5, new SocketMessage()],
    10083: [18, 83, 0, 5, 5, new SocketMessage()],
    10084: [18, 84, 0, 5, 5, new SocketMessage()],
    10087: [18, 87, 0, 5, 5, new SocketMessage()],
    10099: [18, 99, 0, 5, 5, new SocketMessage()],
    10082: [18, 82, 0, 5, 5, new SocketMessage()],
    10085: [18, 85, 0, 5, 5, new SocketMessage()],
    10086: [18, 86, 0, 5, 5, new SocketMessage()],
    10088: [18, 88, 0, 5, 5, new SocketMessage()],
    10090: [18, 90, 0, 5, 5, new SocketMessage()],
    10091: [18, 91, 0, 5, 5, new SocketMessage()],
    10089: [18, 89, 0, 5, 5, new SocketMessage()],
    ...
    10135: [22, 135, 0, 5, 5, new SocketMessage()],
    ...
    10156: [23, 156, 0, 5, 5, new SocketMessage()],
    ...
    10165: [26, 165, 0, 5, 5, new SocketMessage()], //PopoFoudre Need to fix this item IDKN what isn't working but will look into it
    10166: [26, 166, 0, 5, 5, new SocketMessage()], //PopoBigPoop
    10370: [26, 370, 0, 5, 5, new SocketMessage()], //PopoGlace
    10182: [29, 182, 0, 5, 5, new SocketMessage()],
    10183: [29, 183, 0, 5, 5, new SocketMessage()],
    10184: [29, 184, 0, 5, 5, new SocketMessage()],
    10146: [23, 146, 0, 5, 5, new SocketMessage()],
    10147: [23, 147, 0, 5, 5, new SocketMessage()],
    10159: [23, 159, 0, 5, 5, new SocketMessage()],


    10213: [27, 213, 0, 5, 5, new SocketMessage()],

    10235: [25, 235, 0, 5, 5, new SocketMessage()],
    10236: [25, 236, 0, 5, 5, new SocketMessage()],
    10237: [25, 237, 0, 5, 5, new SocketMessage()],
    10238: [25, 238, 0, 5, 5, new SocketMessage()],
    10313: [25, 313, 0, 5, 5, new SocketMessage()],
    10314: [25, 314, 0, 5, 5, new SocketMessage()],
    10315: [25, 315, 0, 5, 5, new SocketMessage()],
    10316: [25, 316, 0, 5, 5, new SocketMessage()],

    10243: [25, 243, 0, 5, 5, new SocketMessage()],
    10244: [25, 244, 0, 5, 5, new SocketMessage()],
    10318: [25, 318, 0, 5, 5, new SocketMessage()],

    10169: [27, 169, 0, 5, 5, new SocketMessage()],
    10187: [27, 187, 0, 5, 5, new SocketMessage()],
    
    10209: [28, 209, 0, 5, 5, new SocketMessage()],
    ...
    10234: [35, 234, 0, 5, 5, new SocketMessage()],
    10259: [37, 259, 0, 5, 5, new SocketMessage()],
    ...
    10378: [53, 378, 0, 5, 5, new SocketMessage()],
    ...
    10340: [48, 340, 0, 5, 5, new SocketMessage()],
    ...
    9212: [33, 212, 0, 5, 4, new SocketMessage()],
    9224: [33, 224, 0, 5, 4, new SocketMessage()],
    9228: [33, 228, 0, 5, 4, new SocketMessage()],
    9260: [33, 260, 0, 5, 4, new SocketMessage()],
    9281: [33, 281, 0, 5, 4, new SocketMessage()],
    9328: [33, 328, 0, 5, 4, new SocketMessage()],
    9344: [33, 344, 0, 5, 4, new SocketMessage()],
    9373: [33, 373, 0, 5, 4, new SocketMessage()],
    9321: [33, 321, 0, 5, 4, new SocketMessage()],

    21036: [9, 36, 0, 5, 2, new SocketMessage()],
    28066: [16, 66, 0, 5, 2, new SocketMessage()],
    28068: [16, 68, 0, 5, 2, new SocketMessage()],
    28072: [16, 72, 0, 5, 2, new SocketMessage()],
    28097: [16, 97, 0, 5, 2, new SocketMessage()],
    28098: [16, 98, 0, 5, 2, new SocketMessage()],
    31101: [19, 101, 0, 5, 2, new SocketMessage()],
    31104: [19, 104, 0, 5, 2, new SocketMessage()],
    31115: [19, 115, 0, 5, 2, new SocketMessage()],
    32117: [20, 117, 0, 5, 2, new SocketMessage()],
    32118: [20, 118, 0, 5, 2, new SocketMessage()],
    32119: [20, 119, 0, 5, 2, new SocketMessage()],
    33122: [21, 122, 0, 5, 2, new SocketMessage()],
    33129: [21, 129, 0, 5, 2, new SocketMessage()],
    34141: [22, 141, 0, 5, 2, new SocketMessage()],
    34143: [22, 143, 0, 5, 2, new SocketMessage()],
    35148: [23, 148, 0, 5, 2, new SocketMessage()],
    36161: [24, 161, 0, 5, 2, new SocketMessage()],
    39168: [27, 168, 0, 5, 2, new SocketMessage()],
    39188: [27, 188, 0, 5, 2, new SocketMessage()],
    42193: [30, 193, 0, 5, 2, new SocketMessage()],
    42201: [30, 201, 0, 5, 2, new SocketMessage()],
    46206: [34, 206, 0, 5, 2, new SocketMessage()],
    46211: [34, 211, 0, 5, 2, new SocketMessage()],
    50267: [38, 267, 0, 5, 2, new SocketMessage()],
    54284: [42, 284, 0, 5, 2, new SocketMessage()],
    56343: [44, 343, 0, 5, 2, new SocketMessage()],
    58304: [46, 304, 0, 5, 2, new SocketMessage()],
    60329: [48, 329, 0, 5, 2, new SocketMessage()],
    65375: [53, 375, 0, 5, 2, new SocketMessage()],
    46230: [35, 230, 0, 5, 2, new SocketMessage()],
    ...
    11482: [23, 151, 0, 5, 1, new SocketMessage()],
    ...
    parsedEventMessage(type, stype, loc5) {
        ...
        if (type == 4) {       //if (!user.uid) {  return; } 
            ...
            if (stype == 1) {
                ...
                if (user) {
                    this.server.database(`UPDATE users SET prison_motif = "${motif}" WHERE login = '${user.login}'`);
                    this.server.database(`UPDATE users SET xp_expire = ${parseInt(user.xp + temps * 1.5)} WHERE login = '${user.login}'`);
                    this.server.database(`UPDATE users SET mapId = 10 WHERE login = '${user.login}'`);
            ...
            if (stype == 1) {
                ...
                packet.bitWriteString(`<font color="#424242"><font color="#000">[INFO] </font> Blablaland.ca Beta <font color="#0f0f0f">v0.4</font></font>`);
                this.send(packet);
                this.connected = true;
            } else if (stype == 5) {
        ...
        if (this.connected) {
            ...
            if (query.length > 0) {
                ...
                if (query.skinid != this.skinId || !arraysEqual(this.skinColor, query.skincolors.split(','))) {
                    ...
                    this.skinColor = query.skincolors.split(',');
                    if (this.data.MONTURE) {
                        let packet = new SocketMessage();
                        packet.bitWriteUnsignedInt(32, this.data.MONTURE[1]);
                        packet.bitWriteBoolean(true);
            ...
            if (stype == 2) {
                ...
                if (user) {
                    ...
                    if (chat[0] != undefined) {
                        ...
                        this.mainUser.skinColor = user.skincolors.split(',');
                        this.skinColor = user.skincolors.split(',');
             ...
             //   if(!user.uid) { return; }
                ...
                if (this.grade > 800) {
                    if (text == "!info") {
                        ...
                        this.user[18251] = this.writeUserFXChange(18250, {
                            loc17: true,
                            id: 4,
                            sid: 16,
                            active: true,
                ...
                if (this.grade >= 200) {
                    ...
                    if (commandes[0] == "!clan") {
                        ...
                        return;
                    }  if (commandes[0] == "!prehistoire") {
                        if (!this.isPrehistoire()) {
                            const planete = loc5.bitReadUnsignedInt(GlobalProperties.BIT_MAP_PLANETID);
                            if (planete == 1) {
                                this.transportToPlanete = 810;
                            } else if (planete == 0) {
                                this.transportToPlanete = 9;
                            }
                        }
                    }
                ...
                if (commandes[0] == "!spaciale") {
                    if (this.IsMapSpacial()) {
                        ...
                        let camera = this.cameraList.getCameraByMap(this.mapId);
                         ...
                         packet.bitWriteBoolean(true); //html
                         packet.bitWriteBoolean(false); //alerte
                         packet.bitWriteString(`<font color="#424242"><font color="#000">[INFO] </font> Blablaland.ca Beta <font color="#0f0f0f">Map par Rastaman#5195</font></font>`);
                         this.send(packet);
                    }
                ...
                if (commandes[0] == "!Arkadev") {
                    if (this.IsMapArkadev()) {
                        ...
                        let camera = this.cameraList.getCameraByMap(this.mapId);
                         ...
                         packet.bitWriteBoolean(true); //html
                         packet.bitWriteBoolean(false); //alerte
                         packet.bitWriteString(`<font color="#424242"><font color="#000">[INFO] </font> Blablaland.ca Beta <font color="#0f0f0f">Map par Seah#6186</font></font>`);
                         this.send(packet);
                    }
            ...
            if (stype == 1) {
                ...
                if (fx_id in map.data.KDO) {
                    ...
                    if (map.data.KDO[fx_id][1] != 3) {
                        ...
                        this.server.database(`UPDATE users SET bbl = ${this.bbl} WHERE login = '${this.login}'`);
           ...
           // if (this.mapId == 499) { return; } //Donjon
            ...
            if (stype == 1) {
                ...
                if (this.data.MAISON_ON || this.data.MAISON_ACTIF) {
                    this.sendMsg("Une erreur est survenue");
                    return;
                }
            ...
            if (stype == 2) {
                ...
                p.bitWriteBoolean(true);
                p.bitWriteUnsignedInt(6, 5);
                p.bitWriteUnsignedInt(GlobalProperties.BIT_SKIN_ID, 95);
                p.bitWriteBoolean(false);
...
class Client extends BblLogged {
    ...
    saveData(type, value) {
        ...
        this.server.database(`UPDATE users SET ${type} = ${value} WHERE session = '${this.session}'`);
    }
    connectionLost() {
        if (this.connected) {
            this.connected = false;
            this.methodeId = 3;
            if (this.uid) {
                this.server.database(`UPDATE chat SET mapId = ${this.mapId} WHERE login = '${this.login}'`);
                this.server.database(`UPDATE chat SET posX = ${this.mainUser.position.x} WHERE login = '${this.login}'`);
                this.server.database(`UPDATE chat SET posY = ${this.mainUser.position.y} WHERE login = '${this.login}'`);
                this.server.database(`UPDATE chat SET direction = ${this.mainUser.direction} WHERE login = '${this.login}'`);
                this.server.database(`UPDATE users SET xp = ${this.xp} WHERE login = '${this.login}'`);
